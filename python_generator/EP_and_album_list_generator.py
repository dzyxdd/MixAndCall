...
# 读取JSON数据
with open('../json_files/EP_and_album_list.json', 'r', encoding='utf-8') as f:
    data = json.load(f)

with open('../templates/template_EP_and_album_list.html', 'r', encoding='utf-8') as f:
...
with open('../docs/music_lib/auto-generated_html/EP_and_album_list.html', 'w', encoding='utf-8') as f:
